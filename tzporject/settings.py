"""
Django settings for tzporject project.
...
SECRET_KEY = 'lh#x#$@$$-y7kvngl$an_^czgido5=581=jqeq$pob8*xlr6k7'
...
WSGI_APPLICATION = 'tzporject.wsgi.application'
